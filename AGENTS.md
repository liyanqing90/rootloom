...
- `plugins/rootloom/skills/project-memory/scripts/project_memory.py` owns optional `.project-memory/` formats; updates must remain explicit, reviewable, standard-library-only, and subordinate to current repository evidence.
