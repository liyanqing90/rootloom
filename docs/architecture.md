...
- process-group termination on timeout, interruption, successful parent exit, or failed parent exit when children remain, with SIGTERM-to-SIGKILL escalation, explicit group-exit confirmation, and a bounded final output drain.
