...
- structured per-model-stage command sidecars, a 32 MiB retained-output verification-batch budget, a 64-command ceiling, and a 120,000-character compact verification prompt ceiling;
