...
| 高保障执行具有确定性 | 固定阶段顺序、已关联来源 ID、ignored/敏感内容元数据化、捕获前范围门禁、映射命令结果、检测到的验证入口指纹与有限修复循环 | 模型证据真实、隐藏 CLI 路径解析、所选命令语义充分、根因正确、业务正确或生产安全 |
